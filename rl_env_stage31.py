...
class A1Env(gym.Env):
    ...
    def __init__(self):
        ...
        # =====================================================
        # TROT PHASE CLOCK — unchanged from stage30
        # =====================================================
        ...
        # =====================================================
        # REFERENCE MOTION — unchanged from stage30
        # =====================================================
        ...
        # CURRICULUM
        #
        # stage30 ran 10 advances x 0.02 = +0.20
        # robot ended at cmd_vel = 0.30 m/s
        # start here at 0.30 and cap — no further increase
        # =====================================================
    ...
    def _get_strict_trot_reward(self, contacts):
        ...
        # =====================================================
        # CHANGE 1: symmetry_penalty coefficient 2.0 -> 4.0
        #
        # stage30 used 2.0 — too weak, TROT-B dominated heavily.
        # 4.0 forces the robot to spend equal time in
        # TROT-A and TROT-B, so both diagonal pairs
        # contribute equally to forward propulsion.
        # =====================================================
        symmetry_penalty = 0.0
        total = self.state_A_steps + self.state_B_steps
        if total > 10:
            ratio = self.state_A_steps / (total + 1e-6)
            symmetry_penalty = 4.0 * abs(ratio - 0.5)   # was 2.0 in stage30
    ...
    def step(self, action):
        ...
        self.data.ctrl[:] = self.base_pose + 0.15 * action   # unchanged
        ...
        # =====================================================
        # CHANGE 2: yaw_rate extracted for yaw penalty
        #
        # qvel[5] = rotation rate around vertical (Z) axis
        # This is the yaw rate — how fast the robot is turning.
        # Penalising this keeps the robot walking straight.
        # =====================================================
        ...
        # =====================================================
        # CHANGE 3: yaw_penalty — NEW, was missing in stage30
        #
        # Penalises rotation around vertical axis.
        # Keeps the robot walking in a straight line.
        # Without this, slight force imbalances cause the
        # robot to gradually rotate and drift sideways.
        # =====================================================
        ...
        if feet_in_air >= 1.0:
            ...
            forward_reward = 0.0
            # =====================================================
            # CHANGE 4: coast_penalty 3.0 -> 1.0
            #
            # 3.0 was too harsh during early training —
            # robot got hammered before it learned to lift feet.
            # 1.0 still discourages coasting but allows
            # gradual learning without overcorrecting.
            # =====================================================
            coast_penalty  = 1.0 * fwd_vel_clipped   # was 3.0 in stage30
