...
from rl_env_stage4 import A1Env
...
model = PPO.load("stage3_trot_3M", env=env)

print("Loaded stage3_trot_3M successfully.")
print("Continuing training with stage4 — force_symmetry_penalty increased.")

checkpoint_callback = CheckpointCallback(
    save_freq=100_000,
    save_path="./checkpoints/",
    name_prefix="stage4_trot"
)
...
model.save("stage4_trot_4M")

print("Stage 4 training completed.")
print("Saved to: stage4_trot_4M")
